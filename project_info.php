...
<div class="row py-3">
    <div class="col-lg-12 text-center mb-4">
        <span class="badge bg-info text-dark px-3 py-2 rounded-pill fw-bold mb-2">COLLEGE PROJECT OVERVIEW</span>
        <h1 class="display-5 fw-extrabold text-white">AI Healthcare – Intelligent Disease Prediction & Health Assistance System</h1>
...
<div class="row g-4 mb-4">
    <div class="col-md-6">
        <div class="card-custom p-4 h-100">
            <h4 class="fw-bold text-white mb-3"><i class="bi bi-bullseye text-info me-2"></i> Project Objectives</h4>
    ...
    <div class="col-md-6">
        <div class="card-custom p-4 h-100">
            <h4 class="fw-bold text-white mb-3"><i class="bi bi-layers-fill text-success me-2"></i> Technology Stack</h4>
            <ul class="text-muted small mb-0 lh-lg">
...
<div class="card-custom p-4 p-md-5 mb-4">
    <h4 class="fw-bold text-white mb-3"><i class="bi bi-diagram-3-fill text-warning me-2"></i> System Architecture Flow</h4>
    <div class="p-4 bg-dark bg-opacity-60 rounded border border-secondary border-opacity-25 text-center font-monospace text-info small">
        Browser Client (HTML/JS) ➔ PHP / Flask Web Server ➔ Python ML REST API ➔ Serialized Joblib Model ➔ Prediction Output ➔ Structured JSON Response
    </div>
</div>
